...
class MyTopology(Topo):
  def __init__(self):
    ...
    self.addLink(coreSwitch, facultySwitch)
    self.addLink(coreSwitch, studentSwitch)
    self.addLink(coreSwitch, dataCenterSwitch)
    self.addLink(coreSwitch, itSwitch)
    ...
    self.addLink(guest1, coreSwitch)
    self.addLink(guest2, coreSwitch)
